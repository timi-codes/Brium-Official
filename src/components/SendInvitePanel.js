  ...
  return (
    <Flex  color="#363636" width="100%" direction="column">
      ...
      <Stack color="#363636">
          ...
          <Text fontSize="1rem" lineHeight="1.5rem">Send our friends your unique invite code or share with them via a tweet or share on facebook</Text>
          <Stack spacing={8} isInline mt="26px">
            ...
            <FormControl>
              ...
              <Stack isInline spacing={4}>
                <IconButton aria-label="Search database" icon={FaTwitter} width="2.6rem" height="2.6rem" fontWeight="bold" backgroundColor="#DFEAF8" rounded="0"/>
                <IconButton aria-label="Search database" icon={FaFacebookF} width="2.6rem" height="2.6rem" fontWeight="bold" backgroundColor="#DFEAF8" rounded="0"/>
              </Stack>
              </FormControl>
          </Stack>
        </Stack>
        <Stack color="#363636" mt="4rem">
          ...
          <Text fontSize="1rem" lineHeight="1.5rem">Send our friends your unique invite by sending it to their email address</Text>
          <Stack spacing={8} isInline mt="26px">

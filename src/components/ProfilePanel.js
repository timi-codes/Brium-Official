      ...
      <Flex alignItems="center">
          <Stack spacing={8}>
              ...
              <Stack color="#363636">
                ...
                <Text fontSize="1rem" lineHeight="1.5rem" color="#6A7781">Driver and taxi license details. Keep an eye on expiration dates. Incase when license expires. please contact customer support. support@brium.africa</Text>
              ...
              <Stack color="#363636">
                  ...
                  <Text fontSize="1rem" lineHeight="1.5rem" color="#6A7781">Passenger sees this info when they request your ride. Keep an eye on expiration dates. Incase when license expires. please contact customer support. support@brium.africa</Text>
                  <Stack spacing={20} isInline mt="26px">
                      <FormControl>

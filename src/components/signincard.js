...
const LoginCard = () => {
  return (
    <CardContainer>
      ...
      <Input type="email" placeholder="Email Address or Phone Number" border="0px" />
      ...
      <OrText>OR</OrText>
      <SocialButton><IconButtonFacebook/></SocialButton>
      <SocialButton><IconButtonGoogle/></SocialButton>
    </CardContainer>
  );
};

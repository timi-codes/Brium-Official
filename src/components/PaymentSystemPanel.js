        ...
        <Box width="100%" backgroundColor="white" p="1.5rem" borderBottom="1px solid #DCE5E7">
          <Flex width="100%" justifyContent="space-between">
            ...
            <Stack isInline alignItems="center">
              <IconButton aria-label="Search database" icon={GoChevronLeft} width="2.6rem" height="2.6rem" fontWeight="bold" backgroundColor="#DFEAF8" rounded="0"/>
              <Text fontSize="15px" px="0.5rem" fontWeight={500}>May 6 - 13, 2019</Text>
              <IconButton aria-label="Search database" icon={GoChevronRight} width="2.6rem" height="2.6rem" backgroundColor="#DFEAF8" rounded="0"/>
            </Stack>
          </Flex>
        ...
        <Box width="100%" backgroundColor="white" py="1.5rem" px="2rem" mt="1.5rem" borderBottom="1px solid #DCE5E7">
          ...
          <Flex>
            <Box mr="3.5rem">
              ...
              <Text fontSize="14px" mt="5px">This is your End of Week Balance carried forward from the previous week. It shows how much Brium owed you or how much you owed Brium before this week started.</Text>
            </Box>
          ...
          <Flex>
            <Box mr="3.5rem">
              ...
              <Text fontSize="14px" mt="5px">This amount shows how much Brium owes you or how much you owe so far this week. Check your transaction details for more information.</Text>
            </Box>
            <Text fontWeight={700} fontSize="1.5rem" lineHeight="2rem">₦0.00</Text>
          </Flex>
          <Divider width="100%" border="1px dashed #DCE5E7" my="1.6rem" backgroundColor="transparent" />

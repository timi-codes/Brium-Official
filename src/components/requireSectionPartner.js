...
const PartnerRequireSection = ({title}) => (
  <RequirementContainer filename="requirement_bg.png">
    ...
    <RequireCard>
        ...
        <TextContainer>
            <SubTitle>Register as a partner</SubTitle>
    ...
    <RequireCard>
     ...
     <RequireCard>
        ...
        <TextContainer>
            <SubTitle>Connect your drivers</SubTitle>
...
export default PartnerRequireSection;

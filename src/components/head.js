...
const Head = ({ metadata }) => (
  <Helmet>
    ...
    <meta name="msapplication-TileColor" content={config.blue} />
    <meta name="msapplication-TileImage" content={msIcon144x144} />
    <meta name="theme-color" content={config.blue} />
  </Helmet>
);

Head.propTypes = {
  metadata: PropTypes.shape({ root: PropTypes.string.isRequired }).isRequired
};

    ...
    <Menu width="3rem">
      <MenuButton backgroundColor="white" border="1.2px solid #DFEAF8" _hover={{ backgroundColor: "white"}} _focus={{ backgroundColor: "white",  outline: 0  }}>
        <Flex justifyContent="space-between" alignItems="center" >
          ...
          <IconButton p="13px" aria-label="Search database" color="#1470DB" icon={GoChevronDown} width="2.6rem" height="2.6rem" fontWeight="bold" backgroundColor="#DFEAF8" rounded="0"/>
        </Flex>
      </MenuButton>
      <MenuList>

  ...
  [4],
  {
    146: function(n, t, e) {
      ...
      var o = e(153),
        ...
        s = e(152);
      function l() {
        var n = a()(['font-size: 15px; max-width: 75%']);
        return (
          (l = function() {
            return n;
          }),
      ...
      function d() {
        var n = a()(['font-size: 30px; max-width: 50%']);
        return (
          (d = function() {
            return n;
          }),
    ...
    152: function(n, t, e) {
      ...
      var o = {
        ...
        f = Object.keys(c).reduce(function(n, t) {
          var e = c[t] / 16;
          return (
            (n[t] = function() {
              return Object(r.b)(
      ...
      var Z = o.colors,
        ...
        an = r.c.main.withConfig({
          displayName: 'Main',
          componentId: 'ysvzwx-0'
        })(['margin:0 auto;width:100%;']),
        rn = r.c.section.withConfig({
          displayName: 'Section',
          componentId: 'sc-9xqsmn-0'
        })(['margin:45px 0;']),
        cn = o.fontSizes,
        fn = o.fonts,
        sn = r.c.button.withConfig({
          displayName: 'Button',
    ...
    189: function(n, t, e) {
      ...
      var o = e(0),
        ...
        s = function(n) {
          var t = n.location,
            e = f.default.getResourcesForPathnameSync(t.pathname);
          return e
            ? a.a.createElement(
                c.a,

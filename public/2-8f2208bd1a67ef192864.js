  ...
  [2],
  {
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    var d = this.props,
                      ...
                      v = d.height,
                      m = d.wrapper,
                      g = (0, s.omit)(this.props, p, l.DEPRECATED_CONFIG_PROPS);
          ...
          return (
            ...
            (r.onStateChange = function(e) {
              ...
              if (
                ...
                var g = !!r.callPlayer('getPlaylist');
                c && !g && r.play(), s();
              }
              t === m && u();
            }),
        ...
        return (
          ...
          o(t, [
            ...
            },
            {
              key: 'render',
              value: function() {
                var e = r({ width: '100%', height: '100%' }, this.props.style);
                return l.default.createElement(
                  'div',
                  { style: e },
                ...
                a.default.Children.forEach(e, function(e) {
                  if (e && e.props) {
                    var o = e.props,
                      a = o.children,
                      i = p(o, ['children']),
                      l = (0, u.convertReactPropstoHtmlAttributes)(i);
          ...
          return (function e(t, n) {
            ...
            if (t && n && 'object' == typeof t && 'object' == typeof n) {
              ...
              if (c && f) {
                ...
                for (l = s; 0 != l--; ) if (!e(t[l], n[l])) return !1;
                return !0;
              }
              if (c != f) return !1;
              ...
              for (l = s; 0 != l--; ) if (!a.call(n, v[l])) return !1;
              if (i && t instanceof Element && n instanceof Element)
                return t === n;
              for (l = s; 0 != l--; )
                if (!(('_owner' === (u = v[l]) && t.$$typeof) || e(t[u], n[u])))
                  return !1;
              return !0;
            }
            return t != t && n != n;
          ...
          function t(t) {
            ...
            (n = e.call(this, t) || this),
              ...
              (0, s.default)(
                ...
                function() {
                  var e = (0, d.inImageCache)(n.props);
                  n.state.isVisible ||
                    'function' != typeof n.props.onStartLoad ||
          ...
          return (
            ...
            (n.componentDidUpdate = function(e) {
              ...
              if ((0, d.imagePropsChanged)(this.props, e)) {
                var n = (0, d.inImageCache)(this.props);
                this.setState(
            ...
            (n.render = function() {
              var e,
                t = (0, y.fixOpacity)((0, p.convertProps)(this.props)),
                n = t.title,
                r = t.alt,
                i = t.className,
                l = t.style,
                ...
                T = (0, p.stripRemainingProps)(P),
                w = 'boolean' == typeof h ? 'lightgray' : void 0 !== h ? h : '',
                S =
                  (!0 === this.state.fadeIn && !this.state.imgCached) ||
                  'soft' === this.props.fadeIn,
                O = this.state.imgLoaded ? v + 'ms' : '0.25s',
                _ = (0, a.default)(
              ...
              if (c) e = c;
                ...
                (e = f),
                  ...
                  'inherit' === s.display && delete _.display;
              }
              var k = (0, d.switchImageSettings)({
                image: e,
      ...
      var r = n(187),
        o = function(e) {
          for (
            ...
            if (r) {
              var o = Array.prototype.slice.call(r).reduce(function(t, n) {
                return n.selectorText === e && '' === t ? n : t;
              }, '');
              if (o) {
                var a = o.cssText ? o.cssText : o.style.cssText;
                return -1 === a.indexOf(o.selectorText)
                  ? o.selectorText + '{' + a + '}'
                  : a;
              }
            }
        ...
        if ((0, r.isString)(e)) {
          ...
          if (n.length > 0 && void 0 !== n[0].style)
            return Object.keys(i(n))
              .filter(function(e) {
                return 0 === e.indexOf('background') && '' !== n[0].style[e];
              })
              .reduce(function(e, t) {
    ...
    255: function(e, t, n) {
      ...
      t.inImageCache = function(e) {
        var t = (0, r.convertProps)(e),
          n = t.fluid ? t.fluid.src : t.fixed ? t.fixed.src : null;
        return o[n] || !1;
      };
      ...
      var i = function(e, t) {
        var n = (0, r.convertProps)(t);
        if (
          'undefined' != typeof window &&
          (void 0 !== n.fluid || void 0 !== n.fixed)
        ) {
          var o = n.fluid ? n.fluid : n.fixed;
          if (a()) {
    ...
    256: function(e, t, n) {
      ...
      t.fixClassName = function(e) {
        var t = e.className,
          n = (0, a.default)(e, ['className']),
          r = (0, i.convertProps)(n),
          o = s(t),
          l = r.fluid ? r.fluid : r.fixed,
          c = ' gbi-' + (0, i.hashString)((l && l.srcSet) || t),
          f = ('' + (t || '') + ((o ? c : '') || '')).trim();
        return !o && u(t), f;
      };
      var f = function(e) {
          ...
          return (
            ...
            o(t, [
              ...
              },
              {
                ...
                value: function(e) {
                  for (
                    var t = [].concat(S(k), S(b.default)), n = 0;
                    n < t.length;
                    n++
                  ) {
                    var r = t[n];
              ...
              },
              {
                ...
                value: function() {
                  var e = this.props,
                    ...
                    d = (0, T.default)(t, n, this.config),
                    y = [p].concat(S(d)).sort(this.sortPlayers),
                    h = v.default.createElement(P.default, {
                      url: t,
                      light: l,
        ...
        return (
          ...
          (n.render = function() {
            var e = f(this.props),
              ...
              E = e.Tag,
              P = e.itemProp,
              T = (e.critical, f(this.props).loading);
            var w = this.state.nativeLazyLoadSupported,
              S = this.state.imgLoaded || !1 === this.state.fadeIn,
              ...
              k = 'boolean' == typeof g ? 'lightgray' : g,
            ...
            if (h) {
              ...
              return (
                'inherit' === a.display && delete L.display,
                u.default.createElement(
                  E,
                  {
                    className: (r || '') + ' gatsby-image-wrapper',
